...
:::{.fragment}
![Efeito de um aumento na renda. Fonte: Nicholson e Snyder (2019).](img/renda.JPG){#fig-fig1}
:::
...
![Efeitos de uma redução em $p_x$. Fonte: Nicholson e Snyder (2019).](img/dec1.JPG){#fig-fig3}
