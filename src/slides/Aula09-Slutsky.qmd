...
:::{.fragment}
$$\frac{d E(p_x, p_y, U)}{d p_x} = \frac{\partial \mathcal{L}}{\partial p_x} = x^h(p_x, p_y, U).$${#eq-eq4}
:::
...
-   A @eq-eq5 nos diz que [a curva de demanda compensada é]{style="color: red"},
...
## Abordagem Gráfica {background-iframe="https://www.econgraphs.org/graphs/consumer/income_substitution/slutsky_decomposition.html" background-interactive="true"}
